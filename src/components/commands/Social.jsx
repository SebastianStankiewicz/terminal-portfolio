  ...
  return (
    <>
      ...
      <div key="linkedin" className='flex'>
        <span className="text-cyan-200 flex" >LinkedIn ‎ <FaLinkedin/> </span>‎ - <a href="www.linkedin.com/in/-sebastian-stankiewicz" className="text-gray-300 hover:bg-blue-700" onClick={() => clickCommand("linkedin")}>‎ www.linkedin.com/in/-sebastian-stankiewicz</a>
      </div>
      <div key="email">
